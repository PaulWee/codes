...
selectInput('x', 'X', names(data)[-1])
selectInput('y', 'Y', names(data)[-1], names(data)[[2]])
selectInput('color', 'Color', c('None', names(data)[-1]))
selectInput('size', 'Size', c('None', names(data)[-1]))
...
https://towardsdatascience.com/create-an-interactive-dashboard-with-shiny-flexdashboard-and-plotly-b1f025aebc9c
